    ...
    return (
        <div>
            ...
            >
                <p>
                    <Trans
                        ...
                        components={{
                            lnk1: (
                                <a href="https://en.wikipedia.org/wiki/OpenEXR" />
                            ),
                            lnk2: (
                                <a href="https://en.wikipedia.org/wiki/RGBE_image_format" />
                            ),
                        }}
                    />
                </p>
            ...
            <FaqItem question={t('faq:q06')} activeQ={clicked} qID="use-hdri">
                ...
                <ol>
                    <li>
                        <a href="https://www.youtube.com/watch?v=Pi4Ft7M8UOU">
                            Blender + Cycles
                        </a>
                    </li>
                    <li>
                        <a href="https://www.youtube.com/watch?v=riBa2YWfajc">
                            3ds Max + Corona
                        </a>
                    </li>
                </ol>
            ...
            <FaqItem question={t('faq:q07')} activeQ={clicked} qID="evs">
                ...
                <p>
                    <Trans
                        ...
                        components={{
                            lnk: (
                                <a href="http://blog.polyhaven.com/what-is-clipping/" />
                            ),
                            strong: <strong />,
                        }}
                    />
                ...
                <p>
                    <Trans
                        ...
                        components={{
                            em: <em />,
                            lnk: (
                                <a href="https://dev.webonomic.nl/fixing-firefox-failed-to-register-update-a-serviceworker-for-scope" />
                            ),
                        }}
                    />
                </p>
