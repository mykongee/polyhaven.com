...
const footer = () => {
    ...
    return (
        <div
            id={styles.footer}
            dir={['ar', 'fa'].includes(router.locale) ? 'rtl' : 'ltr'}
        >
            <h2>
                <Trans
                ...
                <div className={styles.links}>
                    ...
                    <div className={styles.linkListWrapper}>
                        <div className={styles.linkList}>
                            ...
                            <Link
                                prefetch={false}
                                href="https://github.com/Poly-Haven/Public-API"
                            >
                                <a>{t('common:nav.api')}</a>
                            </Link>
                            <Link
                                prefetch={false}
                                href="https://github.com/Poly-Haven/polyhaven.com"
                            >
