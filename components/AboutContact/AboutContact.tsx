...
const AboutPage = () => {
    ...
    return (
        <div>
            ...
            <CorporateSponsors
                header={`${t('common:corporate-sponsor', { count: 100 })}:`}
            />
            ...
            <ul>
                <li>
                    <Trans
                        ...
                        t={t}
                        components={{
                            lnk: <a href="https://blog.polyhaven.com/" />,
                        }}
                    />
                </li>
                <li>
                    <Trans
                        ...
                        components={{
                            lnk: (
                                <a href="https://www.patreon.com/polyhaven/posts?public=true" />
                            ),
                        }}
                    />
                </li>
