...
const Home = () => {
    ...
    const { data: galleryData, error } = apiSWR(`/gallery?limit=22`, {
        ...
        <div className={styles.home}>
            ...
            <div className={styles.sectionWrapper}>
                <div className={styles.assetTypeBanner}>
                    <div
                        className={`${styles.subSection} ${styles.subSectionHDRI}`}
                    >
                        <Link href="/hdris">
                            <a>
                    ...
                    <div
                        className={`${styles.subSection} ${styles.subSectionTex}`}
                    >
                        <Link href="/textures">
                            <a>
                                <div className={styles.assetTypeImage}>
                    ...
                    <div
                        className={`${styles.subSection} ${styles.subSectionMod}`}
                    >
                        <Link href="/models">
                            <a>
                                <div className={styles.assetTypeImage}>
            ...
            <div
                className={`${styles.sectionWrapper} ${styles.windowBannerRend}`}
            >
                ...
                <div className={styles.section}>
                    ...
                    <div
                        className={`${styles.subSection} ${styles.hideMobileHalf}`}
                    />
                </div>
            </div>
            <div
                className={`${styles.sectionWrapper} ${styles.windowBannerClay}`}
            >
            ...
            <div className={styles.sectionWrapper}>
                <div
                    className={`${styles.section} ${styles.sectionHalfMobile}`}
                >
                    <div className={styles.subSection}>
                        <div>
                            <h2>
                            ...
                            <p>
                                Thanks to your donations, we can work
                                sustainably on growing our library of assets and
                                improving our standard of quality.
                            </p>
                        </div>
                    </div>
                    <div className={styles.subSection}>
                ...
                <div
                    className={styles.newestPatrons}
                    style={{ marginTop: '0' }}
                >
                    <h4>{t('s4p2')}</h4>
            ...
            <div className={`${styles.sectionWrapper} ${styles.sectionBrowse}`}>
                ...
                <div
                    className={`${styles.btnBrowse} ${styles.btnBrowseTextures}`}
                >
                    <Button text={t('s5b3')} href="/textures" color="orange" />
                </div>
                <div
                    className={`${styles.btnBrowse} ${styles.btnBrowseModels}`}
                >
            ...
            <div className={`${styles.sectionWrapper}`}>
                <div className={`${styles.section} ${styles.testimonials}`}>
                    <div className={styles.testimonial}>
                        <img
                            src={`https://cdn.polyhaven.com/people/Tudor Bodeanu.jpg?width=80`}
                        />
                        <p>
                            "In today's fast paced content creation environment,
                            Poly Haven is a free library of quality content with
                            no strings attached to get your project off the
                            ground!"
                            <br />
                            <strong>
                    ...
                    <div className={styles.testimonial}>
                        <img
                            src={`https://cdn.polyhaven.com/people/Fenner Rockliffe.jpg?width=80`}
                        />
                        <p>
                            "Any time I'm looking for an awesome HDRI, Material,
                            or high quality model the first place I always look
                            is on polyhaven.com. I've used it a ton for my
                            Blender projects and it's definitely a site every
                            VFX artist should know about!"
                            <br />
                            <strong>
                                -Fenner Rockliffe, VFX Supervisor at Corridor
                                Digital
                            </strong>
                        </p>
                    </div>
            ...
            <div className={styles.sectionWrapper}>
                <div className={styles.section}>
                    ...
                    <div
                        className={`${styles.subSection} ${styles.hideMobileStaff}`}
                    >
            ...
            >
                ...
                <div className={styles.gallery}>
                    {galleryData ? (
                        <Gallery data={galleryData} assetPage={true} />
                    ) : (
                        <Loader />
                    )}
                </div>
