...
const Sponsor = ({ uuid, patron }) => {
    ...
    const doUpdateEmail = (_) => {
        setBusyEmail(true);
        setPatronInfo(uuid, { notify_email: notifyEmail.trim() || null }).then(
            (resdata) => {
                setBusyEmail(false);
                setCurrentData({
                    ...currentData,
            ...
            {autoSponsor && (
                <>
                    ...
                    <div className={styles.row}>
                        ...
                        <Disabled
                            disabled={
                                !isEmail(notifyEmail) && notifyEmail.length
                            }
                            tooltip={t('common:invalid-email')}
                        >
                            <div
                                className={`${styles.iconBtn} ${
                                    notifyEmail !==
                                        currentData['notify_email'] &&
                                    styles.highlight
                                }`}
