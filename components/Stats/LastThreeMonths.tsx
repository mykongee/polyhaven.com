...
const LastThreeMonths = ({ data }: { data: DataSet }) => {
    ...
    for (const stats of Object.values(days)) {
        ...
        stats['7d average total'] = average(
            JSON.parse(JSON.stringify(rollingAverage))
        );
    }
    let i = 0;
    ...
    const all_notes = {
        ...
        '2021-07-13':
            'texturehaven.com and 3dmodelhaven.com redirected to polyhaven.com.',
                        ...
                        <Tooltip
                            ...
                            itemSorter={(item) =>
                                areas
                                    .slice()
                                    .reverse()
                                    .indexOf(item.name.toString())
                            } // Reversed areas without mutating.
                        />
