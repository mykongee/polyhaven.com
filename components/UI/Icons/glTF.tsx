        ...
        >
            <g>
                <g>
                    <path
                        fill={color}
                        d="M419.67,403.73c14.76-16.55,22.56-40.74,22.56-73.32V148.37h-31.17v28.48h-0.38
			...
			C409.52,253.05,408.43,262.29,406.25,271.53z"
                    ...
                    <path
                        fill={color}
                        d="M434.85,422.49c-18.85,17.11-52.53,36.65-98.4,44.32c30.71,5.34,63.07,8.19,96.49,8.2
			c129.24,0.03,242.42-45.09,305.88-109.05c-57.98,38.21-144.83,59.95-241.73,59.95C474.08,425.9,456.47,425.09,434.85,422.49z"
                ...
                <g>
                    <g>
                        <path
                            fill={color}
                            d="M633.84,347.91h-46.96V189.7h-58.92v-40.23h164.81v40.23h-58.92V347.91L633.84,347.91z"
                        />
                    </g>
                    <g>
                        <path
                            fill={color}
                            d="M764.17,347.91h-46.97V149.47h144.99v40.23h-98.02v37.13h85.8v40.23h-85.8V347.91L764.17,347.91z"
                        />
                    </g>
                </g>
                <path
                    fill={color}
                    d="M469.55,100.03h32.71v247.31h-32.71V100.03z"
                />
            </g>
            <g id="TM_2_">
                <path
                    fill={color}
                    d="M902.78,155.29h-7.35v19.11h-6.42v-19.11h-7.35v-5.52h21.11L902.78,155.29L902.78,155.29z"
                />
                <path
                    fill={color}
                    d="M905.65,149.77h9.45l4.24,16.42h0.07l4.24-16.42h9.45v24.63h-6.04v-18.7H927l-5.17,18.7h-4.9l-5.18-18.7
