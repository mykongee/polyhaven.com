...
const GallerySubmit = ({ assets, galleryApiUrl }) => {
    ...
    const conditions = {
        ...
        Link:
            link.trim().length == 0 ||
            isURL(link.trim(), { require_protocol: true }),
        ...
        <div className={styles.wrapper}>
            ...
            <p>
                <Trans
                    i18nKey="submit.s1p1"
                    t={t}
                    components={{ lnk: <LinkText href="/gallery" /> }}
                />
            </p>
            <p>{t('submit.s1p2')}</p>
            <p>
            ...
            <p>
                <Trans
                    ...
                    t={t}
                    components={{
                        lnk: <a href="https://discord.gg/Dms7Mrs" />,
                    }}
                />
            </p>
            <p>{t('submit.s3p4')}</p>
            ...
            <div className={styles.form}>
                ...
                >
                    ...
                    <div className={styles.buttonWrapper}>
                        <label
                            ...
                            className={`${btnStyles.button} ${
                                btnStyles[image ? 'hollow' : 'accent']
                            } ${styles.imageSelect}`}
                        >
                            {image
                                ? t('submit.form.file-change')
                                : t('submit.form.select-change')}
                            <br />
                            <span className={styles.sub}>
                                {t('submit.form.file-size')}
                            </span>
                        </label>
                    </div>
                    <input
                    ...
                    <GalleryFormItem label={t('submit.form.your-name')}>
                        <input
                            type="text"
                            value={author}
                    ...
                    <GalleryFormItem label={t('submit.form.your-email')}>
                        <input
                            type="text"
                            value={email}
                    ...
                    <GalleryFormItem label={t('submit.form.assets')}>
                                ...
                                <div className={styles.assetsWrapper}>
                                    {assetsUsed.map((a) => (
                                        ...
                                        >
                                            <a>
                                                <img
                                                    src={`https://cdn.polyhaven.com/asset_img/thumbs/${a.value}.png?height=100&width=200`}
                                                />
                                            </a>
                                        </Link>
                                    ))}
            ...
            <Popup show={successPopup} hide={(_) => showSuccessPopup(false)}>
                <p>
                    ✅ <strong>{t('submit.form.thanks')}</strong>
                </p>
