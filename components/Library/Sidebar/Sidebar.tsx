...
const Sidebar = (props) => {
    ...
    const [typeHeader, setTypeHeader] = useState(
        t_c(assetTypeName(props.assetType))
    );
    ...
    return (
        <>
            <div
                id={styles.sidebar}
                className={hideSidebar ? styles.hiddenMobile : null}
            >
            ...
            ${props.assetType === 'all' ? styles.activeType : ''}`}
                        ...
                        <Link href="/hdris">
                            <a
                                className={`${styles.type}
            ${
                props.assetType !== 'all' && props.assetType !== 'hdris'
                    ? styles.desaturate
                    : ''
            }
            ${props.assetType === 'hdris' ? styles.activeType : ''}`}
                        ...
                        <Link href="/textures">
                            <a
                                className={`${styles.type}
            ${
                props.assetType !== 'all' && props.assetType !== 'textures'
                    ? styles.desaturate
                    : ''
            }
            ${props.assetType === 'textures' ? styles.activeType : ''}`}
                        ...
                        <Link href="/models">
                            <a
                                className={`${styles.type}
            ${
                props.assetType !== 'all' && props.assetType !== 'models'
                    ? styles.desaturate
                    : ''
            }
            ...
            >
                <IconButton
                    icon={hideSidebar ? <MdFilterList /> : <MdFirstPage />}
